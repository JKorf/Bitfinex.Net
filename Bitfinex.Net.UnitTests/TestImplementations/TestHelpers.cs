...
namespace Bitfinex.Net.UnitTests.TestImplementations
{
    public class TestHelpers
    {
        ...
        public static IBitfinexRestClient CreateAuthenticatedResponseClient<T>(T response, Action<BitfinexRestOptions> options = null)
        {
            var client = (BitfinexRestClient)CreateClient(options ?? new Action<BitfinexRestOptions>((x) => { x.ApiCredentials = new ApiCredentials("Test", "Test"); }));
            SetResponse(client, JsonConvert.SerializeObject(response));
            return client;
        }

        public static IBitfinexRestClient CreateResponseClient<T>(T response, Action<BitfinexRestOptions> options = null)
        {
            var client = (BitfinexRestClient)CreateClient(options);
            SetResponse(client, JsonConvert.SerializeObject(response));
            return client;
