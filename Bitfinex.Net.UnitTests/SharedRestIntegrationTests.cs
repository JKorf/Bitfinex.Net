...
namespace Bitfinex.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IBitfinexRestClientExchangeApiShared GetRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddBitfinex(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IBitfinexRestClient>().ExchangeApi.SharedClient;
        }
