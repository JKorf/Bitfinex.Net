...
var ticker = await restClient.ExchangeApi.ExchangeData.GetTickersAsync(new[] { "tETHUST" });
if (!ticker.Success)
{
...
var subscription = await socketClient.ExchangeApi.SubscribeToTickerUpdatesAsync("tETHUST", update =>
{
