...
* Version 10.10.0 - 24 Mar 2026
    ...
    * Notes for updating:
        * Update ApiCredentials to BitfinexCredentials for authentication, i.e. `ApiCredentials = new ApiCredentials(..)` => `ApiCredentials = new BitfinexCredentials(..)`

* Version 10.9.0 - 06 Mar 2026
